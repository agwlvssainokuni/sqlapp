...
@RequestMapping(PathDef.URI_SQLTOOL_CLAUSE_ID)
public interface SqltoolClauseIdController {
	...
	@ModelAttribute()
	SqltoolClauseForm getForm(@PathVariable(PathDef.PATH_VAR_ID) int id);
	...
	ModelAndView execute(@PathVariable(PathDef.PATH_VAR_ID) int id, @Validated SqltoolClauseForm form,
	...
	ModelAndView download(@PathVariable(PathDef.PATH_VAR_ID) int id, @Validated SqltoolClauseForm form,
			BindingResult binding, Authentication auth, Locale locale, SitePreference sitePref,
			HttpServletRequest request, HttpServletResponse response);

	@RequestMapping(value = PathDef.SUBURI_EXECUTE, params = PathDef.METHOD_UPDATE)
	ModelAndView update(@PathVariable(PathDef.PATH_VAR_ID) int id, @Validated SqltoolClauseForm form,
			BindingResult binding, Authentication auth, Locale locale, SitePreference sitePref,
			HttpServletRequest request);
