...
import cherry.sqlapp.db.gen.dto.MailTemplateAddressCriteria.Criteria;
import cherry.sqlapp.db.gen.dto.MailTemplateAddressCriteria.Criterion;
import cherry.sqlapp.db.gen.dto.MailTemplateAddressCriteria;
import java.util.List;
import java.util.Map;

public class MailTemplateAddressSqlProvider {
     ...
     * @mbggenerated
     */
    public String countByExample(MailTemplateAddressCriteria example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated
     */
    public String deleteByExample(MailTemplateAddressCriteria example) {
        BEGIN();
        DELETE_FROM("MAIL_TEMPLATE_ADDRESS");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated
     */
    public String insertSelective(MailTemplateAddress record) {
        BEGIN();
     ...
     * @mbggenerated
     */
    public String selectByExample(MailTemplateAddressCriteria example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        MailTemplateAddress record = (MailTemplateAddress) parameter.get("record");
        MailTemplateAddressCriteria example = (MailTemplateAddressCriteria) parameter.get("example");
     ...
     * @mbggenerated
     */
    public String updateByPrimaryKeySelective(MailTemplateAddress record) {
        BEGIN();
        UPDATE("MAIL_TEMPLATE_ADDRESS");
     ...
     * @mbggenerated
     */
    protected void applyWhere(MailTemplateAddressCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
