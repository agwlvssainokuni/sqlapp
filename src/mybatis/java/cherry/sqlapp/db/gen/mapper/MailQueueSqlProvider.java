...
import cherry.sqlapp.db.gen.dto.MailQueueCriteria.Criteria;
import cherry.sqlapp.db.gen.dto.MailQueueCriteria.Criterion;
import cherry.sqlapp.db.gen.dto.MailQueueCriteria;
import java.util.List;
import java.util.Map;

public class MailQueueSqlProvider {
     ...
     * @mbggenerated
     */
    public String countByExample(MailQueueCriteria example) {
        BEGIN();
        SELECT("count(*)");
        FROM("MAIL_QUEUE");
     ...
     * @mbggenerated
     */
    public String deleteByExample(MailQueueCriteria example) {
        BEGIN();
        DELETE_FROM("MAIL_QUEUE");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated
     */
    public String selectByExample(MailQueueCriteria example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        MailQueue record = (MailQueue) parameter.get("record");
        MailQueueCriteria example = (MailQueueCriteria) parameter.get("example");
     ...
     * @mbggenerated
     */
    public String updateByPrimaryKeySelective(MailQueue record) {
        BEGIN();
        UPDATE("MAIL_QUEUE");
     ...
     * @mbggenerated
     */
    protected void applyWhere(MailQueueCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
