...
import cherry.sqlapp.db.gen.dto.AsyncProcessFileArgCriteria.Criteria;
import cherry.sqlapp.db.gen.dto.AsyncProcessFileArgCriteria.Criterion;
import cherry.sqlapp.db.gen.dto.AsyncProcessFileArgCriteria;
import java.util.List;
import java.util.Map;

public class AsyncProcessFileArgSqlProvider {
     ...
     * @mbggenerated
     */
    public String countByExample(AsyncProcessFileArgCriteria example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated
     */
    public String deleteByExample(AsyncProcessFileArgCriteria example) {
        BEGIN();
        DELETE_FROM("ASYNC_PROCESS_FILE_ARG");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated
     */
    public String insertSelective(AsyncProcessFileArg record) {
        BEGIN();
     ...
     * @mbggenerated
     */
    public String selectByExample(AsyncProcessFileArgCriteria example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        AsyncProcessFileArg record = (AsyncProcessFileArg) parameter.get("record");
        AsyncProcessFileArgCriteria example = (AsyncProcessFileArgCriteria) parameter.get("example");
     ...
     * @mbggenerated
     */
    public String updateByPrimaryKeySelective(AsyncProcessFileArg record) {
        BEGIN();
        UPDATE("ASYNC_PROCESS_FILE_ARG");
     ...
     * @mbggenerated
     */
    protected void applyWhere(AsyncProcessFileArgCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
