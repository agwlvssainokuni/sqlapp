...
import cherry.sqlapp.db.gen.dto.SqltoolLoadCriteria.Criteria;
import cherry.sqlapp.db.gen.dto.SqltoolLoadCriteria.Criterion;
import cherry.sqlapp.db.gen.dto.SqltoolLoadCriteria;
import java.util.List;
import java.util.Map;

public class SqltoolLoadSqlProvider {
     ...
     * @mbggenerated
     */
    public String countByExample(SqltoolLoadCriteria example) {
        BEGIN();
        SELECT("count(*)");
        FROM("SQLTOOL_LOAD");
     ...
     * @mbggenerated
     */
    public String deleteByExample(SqltoolLoadCriteria example) {
        BEGIN();
        DELETE_FROM("SQLTOOL_LOAD");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated
     */
    public String insertSelective(SqltoolLoad record) {
        BEGIN();
        INSERT_INTO("SQLTOOL_LOAD");
     ...
     * @mbggenerated
     */
    public String selectByExample(SqltoolLoadCriteria example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SqltoolLoad record = (SqltoolLoad) parameter.get("record");
        SqltoolLoadCriteria example = (SqltoolLoadCriteria) parameter.get("example");
     ...
     * @mbggenerated
     */
    public String updateByPrimaryKeySelective(SqltoolLoad record) {
        BEGIN();
        UPDATE("SQLTOOL_LOAD");
     ...
     * @mbggenerated
     */
    protected void applyWhere(SqltoolLoadCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
