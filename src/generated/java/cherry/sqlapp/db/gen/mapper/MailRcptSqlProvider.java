...
import cherry.sqlapp.db.gen.dto.MailRcpt;
import cherry.sqlapp.db.gen.dto.MailRcptCriteria.Criteria;
import cherry.sqlapp.db.gen.dto.MailRcptCriteria.Criterion;
import cherry.sqlapp.db.gen.dto.MailRcptCriteria;
import java.util.List;
import java.util.Map;

public class MailRcptSqlProvider {
     ...
     * @mbggenerated
     */
    public String countByExample(MailRcptCriteria example) {
        BEGIN();
        SELECT("count(*)");
        FROM("MAIL_RCPT");
     ...
     * @mbggenerated
     */
    public String deleteByExample(MailRcptCriteria example) {
        BEGIN();
        DELETE_FROM("MAIL_RCPT");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated
     */
    public String insertSelective(MailRcpt record) {
        BEGIN();
        INSERT_INTO("MAIL_RCPT");
        
        if (record.getMailId() != null) {
            VALUES("MAIL_ID", "#{mailId,jdbcType=BIGINT}");
        }
     ...
     * @mbggenerated
     */
    public String selectByExample(MailRcptCriteria example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        MailRcpt record = (MailRcpt) parameter.get("record");
        MailRcptCriteria example = (MailRcptCriteria) parameter.get("example");
     ...
     * @mbggenerated
     */
    public String updateByPrimaryKeySelective(MailRcpt record) {
        BEGIN();
        UPDATE("MAIL_RCPT");
     ...
     * @mbggenerated
     */
    protected void applyWhere(MailRcptCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
