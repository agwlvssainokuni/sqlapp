...
import cherry.sqlapp.db.gen.dto.AsyncProcess;
import cherry.sqlapp.db.gen.dto.AsyncProcessCriteria;
...
public interface AsyncProcessMapper {
    ...
    @Select({
        "select",
        "ID, LAUNCHED_BY, DESCRIPTION, ASYNC_TYPE, ASYNC_STATUS, REGISTERED_AT, LAUNCHED_AT, ",
        "STARTED_AT, FINISHED_AT, UPDATED_AT, CREATED_AT, LOCK_VERSION, DELETED_FLG",
        "from ASYNC_PROCESS",
        "where ID = #{id,jdbcType=BIGINT}"
    })
    @Results({
    ...
    AsyncProcess selectByPrimaryKey(Long id);
