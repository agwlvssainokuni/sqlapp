...
import cherry.sqlapp.db.gen.dto.SqltoolStatementCriteria.Criteria;
import cherry.sqlapp.db.gen.dto.SqltoolStatementCriteria.Criterion;
import cherry.sqlapp.db.gen.dto.SqltoolStatementCriteria;
import java.util.List;
import java.util.Map;

public class SqltoolStatementSqlProvider {
     ...
     * @mbggenerated
     */
    public String countByExample(SqltoolStatementCriteria example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated
     */
    public String deleteByExample(SqltoolStatementCriteria example) {
        BEGIN();
        DELETE_FROM("SQLTOOL_STATEMENT");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated
     */
    public String insertSelective(SqltoolStatement record) {
        BEGIN();
        INSERT_INTO("SQLTOOL_STATEMENT");
     ...
     * @mbggenerated
     */
    public String selectByExample(SqltoolStatementCriteria example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SqltoolStatement record = (SqltoolStatement) parameter.get("record");
        SqltoolStatementCriteria example = (SqltoolStatementCriteria) parameter.get("example");
     ...
     * @mbggenerated
     */
    public String updateByPrimaryKeySelective(SqltoolStatement record) {
        BEGIN();
        UPDATE("SQLTOOL_STATEMENT");
     ...
     * @mbggenerated
     */
    protected void applyWhere(SqltoolStatementCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
