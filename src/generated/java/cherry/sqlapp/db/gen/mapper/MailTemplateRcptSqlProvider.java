...
import cherry.sqlapp.db.gen.dto.MailTemplateRcptCriteria.Criteria;
import cherry.sqlapp.db.gen.dto.MailTemplateRcptCriteria.Criterion;
import cherry.sqlapp.db.gen.dto.MailTemplateRcptCriteria;
import java.util.List;
import java.util.Map;

public class MailTemplateRcptSqlProvider {
     ...
     * @mbggenerated
     */
    public String countByExample(MailTemplateRcptCriteria example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated
     */
    public String deleteByExample(MailTemplateRcptCriteria example) {
        BEGIN();
        DELETE_FROM("MAIL_TEMPLATE_RCPT");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated
     */
    public String insertSelective(MailTemplateRcpt record) {
        BEGIN();
        INSERT_INTO("MAIL_TEMPLATE_RCPT");
     ...
     * @mbggenerated
     */
    public String selectByExample(MailTemplateRcptCriteria example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        MailTemplateRcpt record = (MailTemplateRcpt) parameter.get("record");
        MailTemplateRcptCriteria example = (MailTemplateRcptCriteria) parameter.get("example");
     ...
     * @mbggenerated
     */
    public String updateByPrimaryKeySelective(MailTemplateRcpt record) {
        BEGIN();
        UPDATE("MAIL_TEMPLATE_RCPT");
     ...
     * @mbggenerated
     */
    protected void applyWhere(MailTemplateRcptCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
